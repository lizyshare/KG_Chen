...
<img src="./Figures/image.png" alt="neo4j知识图谱界面" style="width:70%;">
...
- 项目定义了8种交互模式，通过输入语句匹配对应的模式，并到neo4j数据库中进行查询。8种模式如下：
  ...
  '(.+)作曲的歌曲有',``
- 交互界面展示如下：
<img src="./Figures/project1.png" alt="neo4j知识图谱界面" style="width:70%;">
...
- 交互界面展示如下：
<img src="./Figures/project2.png" alt="neo4j知识图谱界面" style="width:70%;">
